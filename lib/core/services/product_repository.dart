...
class ProductRepository {
  ...
  static final List<Product> _mockProducts = [
    Product(
      ...
      description:
          'Design moderno, monitoramento de saúde 24h e bateria de longa duração. Ideal para quem pratica esportes.',
      price: 199.90,
    ...
    Product(
      ...
      description:
          'Áudio de alta fidelidade e cancelamento de ruído passivo. Conexão estável e ergonômica.',
      price: 79.90,
    ...
    Product(
      ...
      description:
          'Carregador portátil fino e potente. Duas saídas USB para carregamento rápido e simultâneo.',
      price: 129.50,
    ...
    Product(
      ...
      description:
          'Conforto para longas horas de uso. Resolução ajustável e conexão wireless de 2.4GHz.',
      price: 45.00,
    ...
    Product(
      ...
      description:
          'Switches táteis e iluminação RGB customizável. Durabilidade e alta performance para gamers.',
      price: 349.99,
